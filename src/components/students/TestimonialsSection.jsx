...
import { assets, dummyTestimonial } from '../../assets/asset/assets';
...
const TestimonialsSection = () => {
    return (
        <div className='pb-14 px-8 md:px-0'>
            ...
            <div className='grid grid-cols-(--my-grid-cols) gap-8 my-15'>
                    ...
                    <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
                        ...
                        <div className='p-5 pb-7'>
                            <div className='flex gap-0.5'>
                                {[...Array(5)].map((_, i) => (
                                    <img key={i} src={i < Math.floor(testimonial.rating) ? assets.star : assets.star_blank} alt='star image' className='w-3.5 h-3.5' />
                                ))}
                            </div>
