...
import { assets, dummyDashboardData } from '../../assets/asset/assets';
                ...
                <div className='flex flex-wrap gap-5 items-center'>
                    <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
                        ...
                        <div>
                            ...
                            <p className='text-[15px] text-gray-500 '>Total Enrollments</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
                        ...
                        <div>
                            ...
                            <p className='text-[15px] text-gray-500'> Total Courses</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
                        ...
                        <div>
                            ...
                            <p className='text-[15px] text-gray-500'> Total Earnings</p>
                        </div>
                    </div>
                </div>
                <div>
